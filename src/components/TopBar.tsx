    ...
    return (
        <svg {...base} fill="currentColor">
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5ZM7 3.8h10a3.2 3.2 0 0 1 3.2 3.2v10a3.2 3.2 0 0 1-3.2 3.2H7A3.2 3.2 0 0 1 3.8 17V7A3.2 3.2 0 0 1 7 3.8ZM12 7.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 1 0 0-9ZM12 9.3a2.7 2.7 0 1 0 0 5.4 2.7 2.7 0 1 0 0-5.4ZM17.4 5.4a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 1 0 0-2.4Z"
            />
        </svg>
    );
}
